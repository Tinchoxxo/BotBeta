const menu = (hr, prema, pushname, role, userLevel, userXp) => {
prefix = '/'
 return `
╭═══════════════⊷
╰╮ ⟨❗⟩️ 𝖨𝗇𝖿𝗈 𝖡𝗈𝗍 ⟨❗⟩
...
┃│࿊⃟ ${prefix}yt-search
┃│࿊⃟ ${prefix}comandos
┃│࿊⃟ ${prefix}edit-delete
┃│࿊⃟ ${prefix}edit-hacker
┃│࿊⃟ ${prefix}edit-bobspj
┃│࿊⃟ ${prefix}edit-patricio
┃│࿊⃟ ${prefix}edit-hacker2
┃│࿊⃟ ${prefix}edit-loli「 txt 」
┃│࿊⃟ ${prefix}edit-rem「 txt 」
┃│࿊⃟ ${prefix}edit-gura「 txt 」
┃│࿊⃟ ${prefix}edit-kaneki「 txt 」
┃│࿊⃟ ${prefix}edit-nekogirl「 txt|txt 」
┃│࿊⃟ ${prefix}edit-nekoboy「 txt|txt 」
┃╰━━━─── • ──━━━━
┃
┃╭ ⋟ *Sᴛɪᴄᴋᴇʀs*
├┤⟨👾⟩ 𐌼ᴇɴᴜ ᴅᴇ sᴛɪᴄᴋᴇʀs ⟨👾⟩
